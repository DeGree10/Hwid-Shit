...
del /s /q /f /a:h /a:a C:\Program Files\Epic Games\Fortnite\.egstore\3791CB8D4A44788DBBEAF784C2BA5A25.manifest
del /s /q /f /a:h /a:a C:\Program Files\Epic Games\Fortnite\Engine\Binaries\ThirdParty\CEF3\Win64\chrome_elf.dll
