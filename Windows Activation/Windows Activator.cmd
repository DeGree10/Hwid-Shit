...
::   		Windows Activator.
::
::      GET YOUR PC UNBANNED BY THE BEST!
::
::============================================================================
...
set "blank="
set "mas=ht%blank%tps%blank%://sickk%blank%services.com/"
...
::  sickk/office-license-is-not-genuine.html
...
echo Make sure you are using Latest Sickk Activator script.
)
)
...
::
::  The files are encoded in base64 to make Windows Activator.
::
